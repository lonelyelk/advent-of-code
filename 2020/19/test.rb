...
assert_equal "a(ab|ba)", rule_to_regexp_string(parse_rules(rules), "0"), "Wrong regexp"
...
assert_equal 2, count, "Wrong count"

rules = %Q(42: 9 14 | 10 1
9: 14 27 | 1 26
10: 23 14 | 28 1
1: "a"
11: 42 31 | 42 11 31
...
assert_equal 12, count, "Wrong count"
