w1 = %w[R75 D30 R83 U83 L12 D49 R71 U7 L72]
w2 = %w[U62 R66 U55 R34 D71 R55 D58 R83]
...
puts int.map { |pt| pt.map(&:abs).inject(&:+) }.sort.first
puts int.map { |pt| p1.index(pt) + p2.index(pt) + 2 }.sort.first
puts

w1 = %w[R98 U47 R26 D63 R33 U87 L62 D20 R33 U53 R51]
w2 = %w[U98 R91 D20 R16 D67 R40 U7 R15 U6 R7]
